...
***************************************************************************** */
        ...
        da.init();
        const menuBurger = document.querySelector(".button-menu");
        ...
        const btnDropdown = document.querySelector(".menu__item-button");
        const menuDropdown = document.querySelector(".dropdown");
        if (btnDropdown) btnDropdown.addEventListener("click", (function(e) {
            btnDropdown.classList.toggle("_icon-dropdown-active");
            if (menuDropdown) menuDropdown.classList.toggle("_dropdown-active");
        }));
        window["FLS"] = true;
        isWebp();
        spollers();
